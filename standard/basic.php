...
/**
 * The full path and filename of the file. -> 文件的完整路径和文件名 <br>
 * If used inside an include, the name of the included file is returned. -> <br>
 * 如果用在 include 中，则返回被 include 的文件名。 <br>
 * Since PHP 4.0.2, <b>__FILE__</b> always contains an absolute path with symlinks resolved <br>
